...
df_fact_sale = spark.read.table("brozelakehouse.fact_sale") 
df_dimension_date = spark.read.table("brozelakehouse.dimension_date")
df_dimension_city = spark.read.table("brozelakehouse.dimension_city")
...
# MAGIC FROM brozelakehouse.fact_sale FS
# MAGIC INNER JOIN brozelakehouse.dimension_date DD ON FS.InvoiceDateKey = DD.Date
# MAGIC INNER JOIN brozelakehouse.dimension_Employee DE ON FS.SalespersonKey = DE.EmployeeKey
